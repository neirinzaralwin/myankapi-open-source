  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      margin: EdgeInsets.symmetric(
          horizontal: HomeScreen.homePadding, vertical: 10.0),
                ...
                Row(
                  children: [
                    const Icon(Icons.circle,
                        size: 8.0, color: AppColor.primaryColor),
                    const SizedBox(width: 5.0),
                    const Text("Hot topics").headSmall.greyColor,
                  ],
                ),
                TextButton(
                    onPressed: () {},
                    child: const Text("View all").bodyMedium.primaryColor)
              ],
            ),
          ),
          Container(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: const Text("2min", textAlign: TextAlign.end)
                                .bodySmall
                                .greyColor,
                          )
                        ],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Text("5d", textAlign: TextAlign.end)
                            .bodySmall
                            .greyColor,
                      )
                    ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            padding:
                                const EdgeInsets.symmetric(horizontal: 5.0),
                            child: const Text("1week", textAlign: TextAlign.end)
                                .bodySmall
                                .greyColor,
                          )
                        ],
